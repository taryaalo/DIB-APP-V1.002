...
const translations = {
  en: {
    translation: {
      "app_title": "NID Data Extractor",
      "language_select_prompt": "Select Your Language",
      "upload_prompt": "Upload an NID document image",
      ...
      "nid_data": {
          ...
          "familyId": "Family Record No.",
          "tripleName": "Triple Name",
          "surname": "Surname",
          "sex": "Sex",
  ...
  ar: {
    translation: {
      "app_title": "مستخرج بيانات الرقم الوطني",
      "language_select_prompt": "اختر لغتك",
      "upload_prompt": "ارفع صورة وثيقة الرقم الوطني",
...
// 2. ASSETS & ICONS
// =======================================================================
const LANG_SELECT_BG = "https://images.unsplash.com/photo-1554189097-90d3a56a4957?q=80&w=2940&auto=format&fit=crop";
...
const GlobalStyles = () => (
  <style>{`
    ...
    .data-value { color: var(--primary-dark); }
                                ...
                                <div className="data-result-content">
                                    {Object.keys(extractedData).map(key => (
                                        <div className="data-item" key={key}>
                                            <span className="data-label">{t(`nid_data.${key}`)}</span>
